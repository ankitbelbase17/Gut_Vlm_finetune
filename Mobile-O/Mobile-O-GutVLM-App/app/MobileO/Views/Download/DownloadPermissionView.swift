...
struct DownloadPermissionView: View {
        ...
        VStack(spacing: 0) {
            ...
            VStack(spacing: 16) {
                infoRow(icon: "arrow.down.circle.fill", color: .purple,
                        title: "One-Time Download", detail: "~1.8 GB")
                infoRow(icon: "internaldrive.fill", color: .blue,
                        title: "Storage Required", detail: "~2 GB")
    ...
    private var cellularWarning: some View {
        HStack(spacing: 10) {
            ...
            Text("You're on cellular data. This download is ~1.8 GB. WiFi is recommended.")
                .font(.system(size: 13))
                .foregroundStyle(.secondary)
        }
        .padding(12)
